<?php
    ...
    } elseif(preg_match(','.$root_uri.'/index.php/dash_export,', $uri, $matches)) {
        export_register($user);
    } elseif(preg_match(','.$root_uri.'/index.php/get_export,', $uri, $matches)) {
        get_list_export();
    } elseif(preg_match(','.$root_uri.'/index.php/close_export/(?P<id>\d+),', $uri, $matches)) {
        close_export_by_id( $matches['id'] );
    } else {
